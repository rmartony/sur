...
public class LazyTorreroDataModel extends LazyDataModel<Torrero> implements Serializable {

    // Data Source for binding data to the DataTable
    private List<Torrero> datasource;
     ...
     * @param crudService
     */
    public LazyTorreroDataModel(DataAccessService crudService) {
     ...
     */
    @Override
    public List<Torrero> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
        CriteriaBuilder criteriaBuilder = crudService.getCriteriaBuilder();
        CriteriaQuery<Torrero> criteriaQuery = criteriaBuilder.createQuery(Torrero.class);
        Metamodel metamodel = crudService.getMetamodel();
        EntityType<Torrero> entityType = metamodel.entity(Torrero.class);
        Root<Torrero> from = criteriaQuery.from(entityType);
        List<Order> orders = new ArrayList<Order>();

        // count query
        CriteriaQuery<Long> cqCount = criteriaBuilder.createQuery(Long.class);
        Root<Torrero> fromCount = cqCount.from(entityType);
     ...
     * @return Object
     */
    public Object getRowKey(Torrero torrero) {
        return torrero.getId().toString();
    }
     ...
     */
    @Override
    public Torrero getRowData(String rowKey) {
        if (datasource == null)
            return null;
        for (Torrero torrero : datasource) {
            if (torrero.getId().toString().equals(rowKey))
                return torrero;
        }
        return null;
    }
    ...
    public void setWrappedData(Object list) {
        this.datasource = (List<Torrero>) list;
    }
}
