...
*/
    ...
    private void initDatosPrueba() {
        ...
        Departamento d1 = (Departamento) (departamentoService.findWithNamedQuery(Departamento.BY_ID, departamentoParameters).get(0));
        s1.setDepartamento(d1);
        ...
        Departamento d2 = (Departamento) (departamentoService.findWithNamedQuery(Departamento.BY_ID, departamentoParameters).get(0));
...
*/
    ...
    public void initDepartamentos() {
        ...
        departamento.setNombre("Paysandú");
        departamentoService.update(departamento);
        departamento.setId(3);
        departamento.setNombre("Colonia");
        departamentoService.update(departamento);
        departamento.setId(4);
        departamento.setNombre("Durazno");
        departamentoService.update(departamento);
        departamento.setId(5);
        departamento.setNombre("Maldonado");
        departamentoService.update(departamento);
        departamento.setId(6);
        departamento.setNombre("Canelones");
        departamentoService.update(departamento);
        departamento.setId(7);
        departamento.setNombre("San José");
        departamentoService.update(departamento);
        departamento.setId(8);
        departamento.setNombre("Rocha");
        departamentoService.update(departamento);
        departamento.setId(9);
        departamento.setNombre("Soriano");
        departamentoService.update(departamento);
        departamento.setId(10);
        departamento.setNombre("Salto");
        departamentoService.update(departamento);
        departamento.setId(11);
        departamento.setNombre("Artigas");
        departamentoService.update(departamento);
        departamento.setId(12);
        departamento.setNombre("Florida");
        departamentoService.update(departamento);
        departamento.setId(13);
        departamento.setNombre("Río Negro");
        departamentoService.update(departamento);
        departamento.setId(14);
        departamento.setNombre("Rivera");
        departamentoService.update(departamento);
        departamento.setId(15);
        departamento.setNombre("Flores");
        departamentoService.update(departamento);
        departamento.setId(16);
        departamento.setNombre("Cerro Largo");
        departamentoService.update(departamento);
        departamento.setId(17);
        departamento.setNombre("Treinta y Tres");
        departamentoService.update(departamento);
        departamento.setId(18);
        departamento.setNombre("Lavalleja");
        departamentoService.update(departamento);
        departamento.setId(19);
        departamento.setNombre("Tacuarembó");
        departamentoService.update(departamento);
    }
