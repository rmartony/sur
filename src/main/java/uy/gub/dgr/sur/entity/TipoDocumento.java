...
@NamedQueries({
        ...
        @NamedQuery(name = TipoDocumento.BY_NAME, query = "SELECT r FROM TipoDocumento r where r.descripcion = :descripcion"),
...
public class TipoDocumento extends BaseEntity implements Serializable {
    ...
    public final static String BY_NAME = "TipoDocumento.name";
